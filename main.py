...
def save_trade(sym, pnl):
    try:
        ...
        requests.post(f"{SUPA_URL}/rest/v1/trades", headers=headers,
...
def analyze(sym, cid):
    ...
    prompt = f"{sym} {trend} Türkçe kısa karar ver GIR/BEKLE % ver"
