...
🔖 VERSİYON: v4 (belirli tarih aralığı desteği + funding rate maliyeti
    eklendi — v3'te 54 işlem, %83.3 kazanma, +46.50R bulunmuştu; şimdi
    farklı bir dönemde (varsayılan: 2022 ayı piyasası) SAĞLAMLIK testi
    yapıyoruz, ve gerçekçi funding maliyetini düşüyoruz)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
BASLANGIC_TARIHI = "2022-01-01"   # "YYYY-MM-DD" veya None
BITIS_TARIHI     = "2022-12-31"   # "YYYY-MM-DD" veya None (None ise şu an)
GECMIS_GUN     = 365     # SADECE BASLANGIC_TARIHI=None ise kullanılır
...
def main():
    print("🔖 VERSİYON: v4 (tarih aralığı desteği + funding rate maliyeti)\n")
